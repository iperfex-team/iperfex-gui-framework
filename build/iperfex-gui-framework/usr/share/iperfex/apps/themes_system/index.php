...
require_once "libs/iperfexForm.class.php";
...
function formThemes($smarty, $module_name, $local_templates_dir, $pDB, $arrConf, $uid){
    ...
    $arr_themes = $oThemes->getThemes("/var/www/html/".$arrConf['adminFolder']."/web/themes/");
    $formThemes= createFieldForm($arr_themes);
    $oForm = new iperfexForm($smarty, $formThemes);
