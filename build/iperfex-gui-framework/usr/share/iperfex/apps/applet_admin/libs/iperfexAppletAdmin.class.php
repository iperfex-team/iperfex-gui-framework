<?php
 ...
 +----------------------------------------------------------------------+
  ...
  +----------------------------------------------------------------------+
  $Id: iperfexprueba_applets.class.php,v 1.1 2009-12-28 06:12:49 Bruno bomv.27 Exp $ */

class iperfexAppletAdmin {
    var $errMsg;

    function iperfexAppletAdmin()
    {
    }
    ...
    {
        global $arrConf;
        $dsn = "sqlite3:///$arrConf[iperfex_dbdir]/dashboard.db";
        $pDB  = new iperfexDB($dsn);
        $pDB2 = new iperfexDB($arrConf['iperfex_dsn']['iperfex']);
        $pACL = new iperfexACL($pDB2);
