...
require_once "$documentRoot/libs/iperfexOrganization.class.php";
global $arrConf;
...
class orgREST extends REST_Resource
{
    ...
    protected function setSession(){
        ...
        session_start();
        $_SESSION['iperfex_user']=$_SERVER['PHP_AUTH_USER'];
    }
...
class orgActions extends orgREST{
    ...
    function HTTP_GET(){
        ...
        $pOrg = new iperfexOrganization($arrConf['iperfex_dsn']["iperfex"]);
