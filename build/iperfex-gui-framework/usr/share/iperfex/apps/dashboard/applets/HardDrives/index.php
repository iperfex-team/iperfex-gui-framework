...
*/
require_once "libs/iperfexGraphImage.lib.php";
...
class Applet_HardDrives
{
    function handleJSON_getContent($smarty, $module_name, $appletlist)
    {
        ...
        $pipe_hdmodel = popen('/usr/bin/iperfex-helper hdmodelreport', 'r');
    ...
    function handleJSON_dirspacereport($smarty, $module_name, $appletlist)
    {
        ...
        session_commit();
        $pipe_dirspace = popen('/usr/bin/iperfex-helper dirspacereport', 'r');
