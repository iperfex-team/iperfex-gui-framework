...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: iperfexDB.class.php,v 1.2 2007/09/07 00:20:03 bmacias Exp $ */
...
class iperfexDB {
     ...
     */
    function iperfexDB($dsn) // Creo que aqui debo pasar el dsn
    {
    ...
    private function _bindParameters(&$sth, &$param)
    {
        ...
        for ($i = 0; $i < count($param); $i++) {
            ...
            case 'string':
                 ...
                 * truncamiento de dicho cero. Véase bug Iperfex #1694. */
                $data_type = 
