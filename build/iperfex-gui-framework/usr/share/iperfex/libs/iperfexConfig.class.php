...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: iperfexConfig.class.php,v 1.1.1.1 2007/07/06 21:31:55 gcarrillo Exp $ */
...
class iperfexConfig
{
    ...
    function iperfexConfig($directorio, $archivo, $separador="", $separador_regexp="", $usuario_proceso=NULL)
    {
