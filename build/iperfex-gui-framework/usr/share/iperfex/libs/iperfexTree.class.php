...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: iperfexTree.class.php,v 1.1.1.1 2007/07/06 21:31:55 gcarrillo Exp $ */
        ...
        foreach($arr_nodos as $nodo){
           ...
           $url=$prefijo.$url;
             ...
             if(file_exists($url) && is_readable($url)){
                ...
                //<META NAME="keywords" CONTENT="introduccion, test, solo, iperfexsanto, iperfex, santo, solutions, test">
