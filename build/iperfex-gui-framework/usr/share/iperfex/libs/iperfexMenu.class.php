...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: iperfexMenu.class.php,v 1.2 2007/09/05 00:25:25 gcarrillo Exp $ */
...
class iperfexMenu {
    ...
    {
        global $arrConf;
        require_once("libs/iperfexACL.class.php");
        ...
        if (isset($_SESSION)) {
            ...
            if (empty($pDB->errMsg)) {
                ...
                $uiperfex = ((int)$uiperfex != 0);
            }
            unset($pDB);
        }
        
        if ($uiperfex && isset($_SESSION['iperfex_user_permission']))
            return $_SESSION['iperfex_user_permission'];

        
        $superAdmin=$pACL->isUserSuperAdmin($_SESSION['iperfex_user']);
        ...
        if ($uiperfex) $_SESSION['iperfex_user_permission'] = $arrMenuFiltered;
