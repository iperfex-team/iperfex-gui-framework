...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: SOAPhandler.class.php,v 1.0 2011-03-31 14:33:00 Alberto Santos F.  asantos@iperfexsanto.com Exp $*/

$document_root = $_SERVER["DOCUMENT_ROOT"];
require_once("$document_root/libs/misc.lib.php");
require_once("$document_root/configs/default.conf.php");
require_once("$document_root/libs/iperfexDB.class.php");
require_once("$document_root/libs/iperfexACL.class.php");
...
class SOAPhandler
{
    ...
    public function SOAPhandler($className, $soapAddress=null)
    {
        ...
        $this->targetNamespace = "http://www.iperfex.com/webservices";
