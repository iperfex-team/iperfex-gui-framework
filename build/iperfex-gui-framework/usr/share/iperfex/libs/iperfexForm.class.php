...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: iperfexForm.class.php,v 1.4 2007/05/09 01:07:03 gcarrillo Exp $ */
...
*/
global $arrConf;
require_once("{$arrConf['iperfex']}/libs/misc.lib.php");
...
class iperfexForm
{
    ...
    function iperfexForm(&$smarty, $arrFormElements)
    {
        $this->smarty = &$smarty;
    ...
    function validateForm($arrCollectedVars)
    {
        ...
        include_once("{$arrConf['iperfex']}/libs/iperfexValidar.class.php");
