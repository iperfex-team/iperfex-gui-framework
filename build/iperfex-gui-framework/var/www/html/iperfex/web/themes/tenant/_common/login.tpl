...
<head>
	...
	<title>{$smarty.const.HEADTITLE} - {$PAGE_NAME}</title>
	...
	<script type='text/javascript' src="{$WEBPATH}themes/{$THEMENAME}/js/jquery-3.2.1.min.js"></script>
...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<img src="{$smarty.const.LOGO}" width="{$smarty.const.LOGINWIDTH}" height="{$smarty.const.LOGINHEIGHT}" alt="isurveyx logo" />
	...
	<script type='text/javascript' src="{$WEBPATH}themes/{$THEMENAME}/js/npm.js"></script>
