...
/* vim: set expandtab tabstop=4 softtabstop=4 shiftwidth=4:
  ...
  +----------------------------------------------------------------------+
  $Id: themesetup.php,v 1.3 2007/07/17 00:03:42 gcarrillo Exp $ */
...
function themeSetup(&$smarty, $selectedMenu, $pdbACL, $pACL, $idUser)
{
    ...
    $smarty->assign(array(
        "ABOUT_IPERFEX "            =>  _tr('About IPERFEX'),
        "HELP"                      =>  _tr('HELP'),
        "USER_LOGIN"                =>  $_SESSION['iperfex_user'],
        "USER_ID"                   =>  $idUser,
        ...
        "CHANGE_PASSWORD"           =>  _tr("Change IPERFEX Password"),
...
function setIcon($idMenu){
    switch ($idMenu) {
        ...
        case 'managerisdx': return 'fa fa-cog';
        case 'survey': return 'fa fa-paperclip';
