...
<div class="neo-applet-news-row">
    ...
    <a href="https://twitter.com/share?original_referer={$WEBSITE|escape:"url"}&related=&source=tweetbutton&text={$NEWS_ITEM.title|escape:"url"}&url={$NEWS_ITEM.link|escape:"url"}&via=iperfexGui"  target="_blank">
