...
<tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
          <tr>
            <td width="15%"><b>{$SINCRONIZATION}:</b></td>
            <td><input type="checkbox" id="sync" name="sync" value="sync" {if $SYNC eq true} checked {/if} ></span></td>
          </tr>
          <tr> 
          ...
          <tr>
            ...
            <td>{html_select_time prefix="ServerDate_" time=$DATETIME }
            </td>
          </tr>
          <tr>
